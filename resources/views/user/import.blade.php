...
@section('content')
    <div class="import-container">
        ...
        <div class="import-section">
            <h3><i class="bi bi-upload" style="margin-right: 8px;"></i> Import dari Excel</h3>
            ...
            <form action="{{ route('users.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div style="margin-top: 20px; display: flex; gap: 12px; align-items: center;">
                    ...
                    <a href="{{ route('users.export') }}" class="template-link" download>
        ...
        <!-- Export Section -->
        <div class="import-section">
            <h3><i class="bi bi-download" style="margin-right: 8px;"></i> Export Data</h3>
            <p style="color: var(--gray-600); font-size: 13px; margin-bottom: 16px;">
                Unduh semua data user dalam format CSV untuk backup atau analisis lebih lanjut.
            </p>
            <a href="{{ route('users.export') }}" class="btn-export" download>
            ...
            <table style="width: 100%; font-size: 12px; border-collapse: collapse;">
                ...
                <tbody>
                    <tr style="border-bottom: 1px solid var(--gray-200);">
                        ...
                        <td style="padding: 8px;">Nama lengkap user</td>
                    </tr>
                    <tr style="border-bottom: 1px solid var(--gray-200);">
                        <td style="padding: 8px;">email *</td>
                        <td style="padding: 8px;">Email</td>
                        <td style="padding: 8px;">Email unik user</td>
                    </tr>
                    <tr style="border-bottom: 1px solid var(--gray-200);">
                        <td style="padding: 8px;">nomor_induk *</td>
                        <td style="padding: 8px;">Text</td>
                        <td style="padding: 8px;">NIM/NIP user</td>
                    </tr>
                    <tr style="border-bottom: 1px solid var(--gray-200);">
                        <td style="padding: 8px;">role</td>
                        <td style="padding: 8px;">Text</td>
                        <td style="padding: 8px;">admin, dosen, atau mahasiswa</td>
                    </tr>
                    <tr style="border-bottom: 1px solid var(--gray-200);">
                    ...
                    <tr style="border-bottom: 1px solid var(--gray-200);">
                        ...
                        <td style="padding: 8px;">Text</td>
                        <td style="padding: 8px;">id atau en</td>
                    </tr>
                </tbody>
            </table>
